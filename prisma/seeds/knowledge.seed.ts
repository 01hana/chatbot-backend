...
const KNOWLEDGE_ENTRIES: {
  ...
  {
    sourceKey: 'o-ring-material-guide',
  ...
  {
    sourceKey: 'mechanical-seal-troubleshoot',
    category: 'product-spec',
    title: '機械密封常見故障排除',
    content:
  ...
  {
    sourceKey: 'industrial-valve-selection',
    category: 'product-spec',
    title: '工業閥門規格與選型說明',
    content:
...
export async function seedKnowledge(prisma: PrismaClient): Promise<void> {
  ...
  console.log(`  KnowledgeEntry: ${upserted} entries upserted`);
}
